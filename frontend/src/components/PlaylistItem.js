...
//           onClick={() => console.log('Playlist clicked')} // Log or handle the click
//         >
...
// const PlaylistItem = ({ coverImage, name, genre, description, hashtags, link, onClick }) => (
//   <Link to={link} style={{ textDecoration: 'none' }}>
//     <div style={styles.container} onClick={() => onClick()}> {/* Call onClick here */}
//       <img src={coverImage} alt={name} style={styles.coverImage} />
//       <div style={styles.info}>
//         <h3 style={styles.name}>{name}</h3>
//         <div style={styles.genreBubble}>{genre}</div>
